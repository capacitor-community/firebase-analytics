...
public class FirebaseAnalytics extends Plugin {
    ...
    public void load() {
        ...
        mFirebaseAnalytics = com.google.firebase.analytics.FirebaseAnalytics.getInstance(getActivity());
    }
        ...
        try {
            if (call.hasOption("screenName")) {
                ...
                getActivity().runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        mFirebaseAnalytics.setCurrentScreen(getActivity(), screenName, nameOverride);
                    }
                });
                call.success();
            } else {
